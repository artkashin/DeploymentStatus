...
export interface CustomerLatest { customerId: string; customerName: string; eventId: string; status: RunStatus; mode: DeploymentMode; completedAt: string; summary: Summary; bcVersion?: string; packageVersion?: string }
...
export interface Deployment { eventId: string; source: Source; customer: Customer; mode: DeploymentMode; status: RunStatus; startedAt: string; completedAt: string; detailCompleteness: string; summary: Summary; artifactSource?: ArtifactSourceReference; operations?: Operation[] }
