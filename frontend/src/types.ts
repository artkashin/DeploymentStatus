...
export interface TenantAppState { tenantId: string; tenantLabel?: string; applicationId?: string; applicationName: string; publisher?: string; desiredVersion?: string; installedVersion?: string; observedAt?: string; state: DesiredAppHealth; lastOutcome?: OperationOutcome; message?: string }
